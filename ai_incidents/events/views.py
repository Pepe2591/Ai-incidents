...
from .serializers import (CameraModelSerializer, FiresModelSerializer, CollapseModelSerializer, AccidentModelSerializer,
...
class AccidentModelViewSet(viewsets.ModelViewSet): 
    queryset = Event.objects.all()
    serializer_class = AccidentModelSerializer
